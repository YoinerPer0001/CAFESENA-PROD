...
import validateTokenCreate from '../../validators//Validator create/tokens.validators.js';
import validateTokenUpdate from '../../validators/Validator update/tokens.validators.js';
 ...
 *                 message: algo salio mal
 */
routesTokens.get('/api/v1/tokens/type/:tipo',validateTokenCreate,verifyToken, GetTokenssxTipo)
/**
 * @swagger
 ...
 *               message: algo salió mal
 */
routesTokens.post('/api/v1/tokens/create',validateTokenUpdate,verifyToken, InsertToken);
/**
 * @swagger
