...
import validateProductosCreate from "../../validators/Validator create/productos.validators.js"
import validateProductosUpdate from "../../validators/Validator update/productos.validators.js";
 ...
 *               message: algo salió mal
 */
routesProductos.post('/api/v1/products/create',validateProductosCreate,verifyToken, createProducts);
 ...
 *               message: algo salió mal
 */
routesProductos.put('/api/v1/products/update/:id',validateProductosUpdate,verifyToken, updateProductos);
