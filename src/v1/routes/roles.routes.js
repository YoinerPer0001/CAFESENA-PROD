...
import validateRolesCreate from '../../validators/Validator create/roles.validators.js';
import validateRolesUpdate from '../../validators/Validator update/roles.validators.js';
 ...
 *               message: algo salió mal
 */
routesRoles.post('/api/v1/roles/create',validateRolesCreate,verifyToken, createRoles);
 ...
 *               message: algo salió mal
 */
routesRoles.put('/api/v1/roles/update/:id',validateRolesUpdate,verifyToken, UpdateRoles);
