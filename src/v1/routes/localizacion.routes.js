...
import validateLocalizacionCreate from '../../validators/Validator create/localizacion.validators.js';
import validateLocalizacionUpdate from "../../validators/Validator update/localizacion.validators.js";
 ...
 *               message: algo salió mal
 */
routesLocation.post('/api/v1/localizaciones/create',validateLocalizacionCreate, verifyToken, createLocations)
/**
 * @swagger
 ...
 *               message: algo salió mal
 */
routesLocation.put('/api/v1/localizaciones/update/:id',validateLocalizacionUpdate, verifyToken, UpdateLocations)
